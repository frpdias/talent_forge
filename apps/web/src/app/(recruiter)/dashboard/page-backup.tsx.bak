              ...
              {loading ? (
                ...
                <div className="divide-y divide-gray-50">
                  {recentActivity.slice(0, 8).map((activity, index) => (
                    <div 
                      key={activity.id} 
                      className="p-5 hover:bg-gradient-to-r hover:from-blue-50 hover:to-transparent transition-all group flex items-center gap-5"
                    ...
                    >
                      <div className="relative flex-shrink-0">
                        ...
                        {index < recentActivity.length - 1 && (
                          <div className="absolute top-12 left-6 w-0.5 h-10 bg-gradient-to-b from-gray-200 to-transparent" />
                        )}
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <ArrowRight className="h-5 w-5 text-gray-300 group-hover:text-blue-600 group-hover:translate-x-2 transition-all flex-shrink-0" />
                      </div>
                    </div>
                  ))}
                </div>
