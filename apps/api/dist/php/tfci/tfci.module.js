...
const tfci_controller_1 = require("./tfci.controller");
...
exports.TfciModule = TfciModule = __decorate([
    (0, common_1.Module)({
        controllers: [tfci_controller_1.TfciController],
        providers: [tfci_service_1.TfciService],
        exports: [tfci_service_1.TfciService],
    })
], TfciModule);
