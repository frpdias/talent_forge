...
export declare class EmployeesController {
    ...
    create(orgId: string, userId: string, createEmployeeDto: CreateEmployeeDto): Promise<Employee>;
    ...
    findAll(orgId: string, userId: string, organizationId?: string, status?: 'active' | 'inactive' | 'terminated', department?: string, managerId?: string, search?: string): Promise<EmployeeWithManager[]>;
    ...
    findOne(orgId: string, userId: string, id: string): Promise<EmployeeWithManager>;
    update(orgId: string, userId: string, id: string, updateEmployeeDto: UpdateEmployeeDto): Promise<Employee>;
